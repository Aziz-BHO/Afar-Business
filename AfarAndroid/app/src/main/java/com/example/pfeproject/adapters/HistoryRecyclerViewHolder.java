...
public class HistoryRecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    TextView cmd_point;
    @BindView(R.id.cmd_articleName)
    TextView cmd_articleName;
    @BindView(R.id.view)
    View view;
    ...
    public void UpdateHistoryData(Command cmd, Context ctx) {
        ...
        cmd_point.setText(String.valueOf(cmd.getProduct().getDiscountPoints()));
        cmd_articleName.setText("#"+cmd.getProduct().getName()+" - "+cmd.getProduct().getEntreprise().getName());
    }
}
